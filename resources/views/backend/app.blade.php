        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item has-treeview {{request()->is('admin/pages','admin/pages-add') ? 'menu-open' : ''}} ">
                        <a href="#" class="nav-link">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="{{route('page-add')}}" class="nav-link {{request()->is('admin/pages-add') ? 'active' : ''}} ">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Sayfa Ekle</p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item has-treeview {{request()->is('admin/sliders','admin/slider-add') ? 'menu-open' : ''}} ">
                        <a href="" class="nav-link">
                    ...
                    <li class="nav-item has-treeview {{request()->is('admin/menus','admin/menu-add') ? 'menu-open' : ''}} ">
                        <a href="#" class="nav-link">
